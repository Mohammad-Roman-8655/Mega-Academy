  ...
  return (
    ...
    <div className='flex lg:flex-row md:flex-row sm:flex-col flex-col  gap-4 items-center w-[100%] justify-center my-10'>
    {
            DownloadForms.map((DownloadForm,idx) => {
             return (
              <a key={idx} href={DownloadForm.examTimetable} className='lg:w-[30%] md:w-[30%] sm:w-[70%] w-[70%]  text-center border-2 hover:border-black rounded-lg p-5  text-xl  bg-blue-700 hover:bg-pink-300 text-white font-semibold hover:underline shadow-2xl '>Download Exam Timetable</a> 
             )
            })
           }
