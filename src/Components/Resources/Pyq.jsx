...
<option value="Standards" className='p-2'>Select Class </option>
    ...
    <option value="12th">12th</option>
          ...
          <div className="row-1 flex  justify-center mt-[10%]  w-[100%] mb-[10%]">
            <button onClick={() => fetchPyqs(selectedStandard)} className='lg:w-[30%] md:w-[30%] sm:w-[80%] w-[80%] lg:text-xl md:text-xl sm:text-lg text-lg text-white font-bold lg:p-3 md:p-3 sm:p-1 p-1 border-2 rounded-md bg-blue-500 border-blue-950 hover:border-black '>Search</button>
          </div>
          </div>
              ...
              Pyqs.map((Pyq,idx)=>{
                return(
                  <tr key={idx}>
                    ...
                    <td className='border border-black lg:p-5 md:p-5 sm:p-2 p-2 lg:text-lg md:text-lg sm:text-md text-md '>{Pyq.subjectName}</td>
                    <td className='border border-black lg:p-5 md:p-5 sm:p-2 p-2  font-bold '><a className="lg:text-lg md:text-lg sm:text-md text-md border-2 bg-blue-500 hover:border-black text-white lg:p-3 md:p-3 sm:p-1 p-1 rounded-lg" href={Pyq.pyqUrl}>Download</a></td>
                  </tr>
                )
              })
            }
