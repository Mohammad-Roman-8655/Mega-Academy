  ...
  return (
    <div className='w-full'>
          <div className='flex items-center  w-[100%] mx-auto lg:p-4 md:p-4 sm:p-3 p-3 m-5 text-center bg-blue-900 mb-10 '>
             <h1 className='text-center text-2xl mx-auto text-white font-bold'>STUDY NOTES</h1>
          </div>
...
<select id="subjectName" className='border-2  h-10 rounded-md ' value={selectedSubject} onChange={handleSubjectChange}>
   ...
   <option value="General Knowledge(G.K)">General Knowledge(G.K)</option>
          ...
          <div className="row-1 flex justify-center mt-[10%] lg:flex-row md:flex-col sm:flex-col flex-col w-full mb-[10%]">
            <button  onClick={() => {fetchStudyNotes(selectedStandard,selectedSubject)}} className='mx-auto lg:w-[30%] md:w-[30%] sm:w-[80%] w-[80%] lg:text-xl md:text-xl sm:text-lg text-lg text-white font-bold lg:p-3 md:p-3 sm:p-1 p-1 border-2 rounded-md bg-blue-500 hover:border-black '>Search</button>
          </div>
          </div>
          <div className='Notes-area my-20'>
            <div className='individual-pdfs'>
              <table className='border-collapse border border-black mx-auto lg:w-[85%] md:w-[85%] sm:w-[95%] w-[95%] text-center shadow-3xl'>
               ...
               <caption className='border border-black lg:p-5 md:p-5 sm:p-2 p-2 lg:text-2xl md:text-2xl sm:text-xl text-xl font-bold bg-blue-900 text-white'>{selectedSubject}</caption>
               <thead>
               <tr>
              ...
              StudyNotes.map((StudyNote,idx)=>{
                return(
                  <tr key={idx}>
                    ...
                    <td className='border border-black lg:p-4 md:p-4 sm:p-2 p-2 lg:text-lg md:text-lg sm:text-md text-md '>{StudyNote.chapter}</td>
                    <td className='border border-black lg:p-4 md:p-4 sm:p-2 p-2  font-bold '><a className="lg:text-lg md:text-lg sm:text-md text-md border-2 bg-blue-500 hover:border-black text-white  lg:p-3 md:p-3 sm:p-1 p-1 rounded-lg" href={StudyNote.notesUrl}>Download</a></td>
                  </tr>
                )
              })
            }
