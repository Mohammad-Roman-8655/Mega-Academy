            ...
            <div className='individual-pdfs'>
              <table className='border-collapse border border-black mx-auto lg:w-[85%] md:w-[85%] sm:w-[95%] w-[95%] text-center shadow-3xl'>
               ...
               <caption className='border border-black lg:p-5 md:p-5 sm:p-2 p-2 lg:text-2xl md:text-2xl sm:text-xl text-xl font-bold bg-blue-900 text-white'>Science</caption>
                ...
                {
              NotesData.map((SubjectData,ChapterNo)=>{
                return(
                  <tr key={ChapterNo}>
                    ...
                    <td className='border border-black lg:p-4 md:p-4 sm:p-2 p-2  font-bold '><a className="lg:text-lg md:text-lg sm:text-md text-md border-2 bg-blue-500 hover:border-black text-white  lg:p-3 md:p-3 sm:p-1 p-1 rounded-lg" href={SubjectData.DownloadLink}>Download</a></td>
                  </tr>
                )
              })
            }
