    ...
    <div className='w-full my-20'>
       <div className='flex items-center  w-[80%] mx-auto p-5 m-5 text-center bg-blue-900 rounded-lg'>
        ...
        <div className='flex lg:flex-row md:flex-row sm:flex-col flex-col gap-4 items-center w-[100%] justify-center my-10'>
           ...
           <NavLink className='lg:w-[40%] md:w-[40%] sm:w-[70%] w-[70%] text-center border-2 hover:border-black rounded-lg p-5 text-xl bg-blue-700 hover:bg-green-300 text-white font-semibold hover:underline shadow-2xl' to='/Resources/ParentalGuides'>PARENTS GUIDES</NavLink>
        </div>
        <div className='flex lg:flex-row md:flex-row sm:flex-col flex-col gap-4 items-center w-[100%] justify-center my-10'>
