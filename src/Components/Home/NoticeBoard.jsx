...
function NoticeBoard() {
  return (
   <div className=' lg:flex md:flex sm:block block justify-between w-[98%] lg:h-[50vh] md:h-[50vh] sm:h-[100vh]  h-[110vh] py-5 rounded-md lg:mx-5 md:mx-5 sm:mx-2 mx-2 lg:my-5 md:my-5 sm:my-2 my-2 bg-gradient-to-r from-sky-500 to-gray-700'>
         <div className='left-side lg:w-[50%] md:w-[50%] sm:w-[100%] w-[100%]'>
             <div className=' items-center'>
              ...
              <div className=' p-5 border-2 lg:m-5 md:mx-5 md:my-5 sm:mx-5 sm:my-5 mx-10 my-5 rounded hover:border-black overflow-scroll overflow-x-hidden h-[30vh] bg-white'>
