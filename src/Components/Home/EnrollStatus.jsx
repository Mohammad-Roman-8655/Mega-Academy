     ...
     <div>
        ...
        <div className='w-full ml-[40px]'>
            <div className=' w-[90%] flex justify-center items-center mx-10 text-justify'>
                <div className=' h-[270px] w-1/4 text-center m-5 border-2 p-7 rounded-md border-blue-400  hover:bg-blue-400 hover:border-black'>
            ...
            <div  className=' w-[90%] flex justify-center items-center mx-10 text-justify'>
                ...
                <div className='h-[270px] w-1/4 h-90 text-center m-5 border-2 p-7 rounded-md border-blue-400  hover:bg-blue-400 hover:border-black'>
                ...
                <div className='h-[270px] w-1/4 text-center m-5 border-2 p-8 rounded-md border-blue-400  hover:bg-blue-400 hover:border-black'>
